...
if asphalt_in_truck >= asphalt_needed:
    print(f"Path width : {path_width} METERS \n\n - For an ideal path of 2 meters - \nAsphalt needed for the path: "
          f"{asphalt_needed} SQUARE METERS\nAsphalt left: {round(asphalt_in_truck - asphalt_needed, 2)} SQUARE METERS")
    quit()

print(f"Path width : {path_width} METERS \n\n - For an ideal path of 2 meters - \nAsphalt needed for the path: "
      f"{asphalt_needed} SQUARE METERS\nAsphalt to add: {round(asphalt_needed - asphalt_in_truck, 2)} SQUARE METERS")